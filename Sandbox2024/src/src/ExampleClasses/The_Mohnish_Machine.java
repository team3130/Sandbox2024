...
public class The_Mohnish_Machine {
    public static void main(String[] args) {
        Baby_Mohnish normalMohnish = new Baby_Mohnish("Attention! bruh.", "INDIA", 18, 6.1, true, true, 1.5, "sly dog", true, 80, "caprisun", true);
        ...
        Baby_Mohnish middleAgeMohnish = new Baby_Mohnish("Bone digadone!", "blasian", 34, 5.3, false, true, 1, "", true, 50, "hot",  true);
        ...
        babyMohnish.isCatchPhraseCool();
        babyMohnish.isDangerous();
        ...
        superMohnish.isCatchPhraseCool();
        superMohnish.isDangerous();
        ...
        middleAgeMohnish.isCatchPhraseCool();
        middleAgeMohnish.isDangerous();
